...
import { faBuildingColumns, faCamera, faMoneyBill, faPlus, faSun } from "@fortawesome/free-solid-svg-icons";
        ...
        <SafeAreaProvider>
            <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
                ...
                <View style={styles.marginBottom}>
                    <Text>{'     '}</Text>
                    <Text><FontAwesomeIcon size={55} icon={faBuildingColumns}/></Text>
                    <Text>{'     '}</Text>
                    <Text style={styles.Title}>Museum Puget</Text>
                    ...
                    <Text>{'     '}</Text>
                    <Text style={styles.Subtitle3}>Generated by <Image source={require("/home/diogofalcao/Desktop/IHC/TravelMate/assets/chatgpt-icon.png")} style={styles.chat} /> ChatGPT </Text>
                </View>
