...
import { faCamera, faMoneyBill, faPlus, faSprayCan, faSun } from "@fortawesome/free-solid-svg-icons";
        ...
        <SafeAreaProvider>
            ...
            <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
                <View style={styles.marginBottom}>
                    ...
                    <Text style={styles.Title}>Novo POI</Text>
                    <Text style={styles.Subtitle}>A generar texto...</Text>
                    <Text style={styles.Subtitle3}>
                        Generating text by{" "}
                        <Image
                            source={require("../../../assets/chatgpt-icon.png")}
